...
class Migrations {
    ...
    static async applyMigrations() {
        ...
        for (const migration of notApplied) {
            ...
            fs.writeFileSync(Migrations.resolvePath(Migrations.migrationsFolder, migration.filename), JSON.stringify({
                ...migration,
                applied: true,
            }));
        }
    ...
    static async rollbackToMigration(id) {
        ...
        for (let i = rollbackItems.length - 1; i >= 0; i--) {
            ...
            fs.writeFileSync(Migrations.resolvePath(Migrations.migrationsFolder, rollbackItems[i].filename), JSON.stringify({
                ...rollbackItems[i],
                applied: false,
            }));
        }
